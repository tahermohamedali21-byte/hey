...
import type { GroupMembershipRequestApprovedNotificationFragment } from "@/indexer/generated";

interface GroupMembershipRequestApprovedNotificationProps {
  notification: GroupMembershipRequestApprovedNotificationFragment;
}

const GroupMembershipRequestApprovedNotification = ({
  notification
}: GroupMembershipRequestApprovedNotificationProps) => {
  const { approvedBy, group } = notification;
